    ...
    },
    {
        ...
        "parts": [
            ...
            },
            {
                ...
                "parts": [
                    ...
                    },
                    {
                        ...
                        "abstract":
                            "Découverte de Pandas, librairie de référence pour le traitement des données tabulaires en Python.",
                        "authors": ["inseefrlab"],
                        "contributors": ["Romain Avouac"],
                        "types": ["Notebook Python"],
                        "tags": ["discover", "learn"],
                    ...
                    },
                    {
                        ...
                        "abstract":
                            "Exploration des bases de la visualisation de données avec Python : les graphiques simples de Pandas et les visualisations esthétiques de Seaborn.",
                        "authors": ["inseefrlab"],
                        "contributors": ["Romain Avouac"],
                        "types": ["Notebook Python"],
                        "tags": ["discover", "learn"],
            ...
            },
            {
                "name": "Projets",
                "abstract":
                    "Des projets de code pour mettre en application les enseignements de la formation",
                "authors": ["inseefrlab"],
                "contributors": ["Romain Avouac"],
                "types": ["Notebook Python"],
                "tags": ["discover", "learn"],
                ...
                "parts": [
                    {
                        ...
                        "abstract":
                            "Un projet de code pour mettre en pratique les éléments fondamentaux de Python : structures de données, boucles, fonctions, conditions.",
                        "authors": ["inseefrlab"],
                        "contributors": ["Romain Avouac"],
                        "types": ["Notebook Python"],
                        "tags": ["discover", "learn"],
                    ...
                    },
                    {
                        ...
                        "abstract":
                            "Ce projet a pour objectif de reproduire une analyse standard à laquelle un statisticien peut être confronté. Il repose sur l'utilisation de la librairie pandas et des librairies de visualisation usuelles (matplotlib, seaborn).",
                        "authors": ["inseefrlab"],
                        "contributors": ["Romain Avouac"],
                        "types": ["Notebook Python"],
                        "tags": ["discover", "learn"],
                        ...
                        "imageUrl":
                            "https://raw.githubusercontent.com/InseeFrLab/www.sspcloud.fr/main/src/assets/img/python.jpg",
                        "deploymentUrl":
                            "https://datalab.sspcloud.fr/launcher/ide/jupyter-python?autoLaunch=true&name=python-initiation&init.personalInit=%C2%ABhttps://raw.githubusercontent.com/InseeFrLab/formation-python-initiation/main/utils/init_onyxia.sh%C2%BB&init.personalInitArgs=%C2%ABprojects%20RP%C2%BB&security.allowlist.enabled=false",
                    },
                ],
            },
        ],
